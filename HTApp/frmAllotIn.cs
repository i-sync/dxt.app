...
namespace HTApp
{
    public partial class frmAllotIn : Form
    {
        bool isloaded = false;
        ...
        public frmAllotIn()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderByDismantle("", out ds, "20");
        ...
        private void frmAllotIn_Load(object sender, EventArgs e)
        {
        ...
        private bool verifyArrive(string OrderCode)
        {
            try
            {
                DataSet ds;
                if (rbtOther.Checked)
                    tempSIO = StockInBusiness.CreateSIOrderByDismantle("20", "", OrderCode, out ds);
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderByDismantle("20", "", cCode, out ds);
            if (sk == null)
                return true;
