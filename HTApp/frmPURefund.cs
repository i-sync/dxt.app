...
namespace HTApp
{
    public partial class frmPURefund : Form
    {
        bool isloaded = false;
        ...
        public frmPURefund()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderArrive("", "", "", 1, out ds);
        ...
        private void frmPURefund_Load(object sender, EventArgs e)
        {
        ...
        private bool RecordNum()
        {
            ...
            try
            {
                if (txtOrder.Tag != null)
                {
                    ...
                    {
                        MessageBox.Show("扫描数量大于应退货数量！" + Environment.NewLine + "应不大于" + sdl.Nquantity.ToString("F4") + sdl.Inva_unit);
                        return false;
                    }
