...
namespace HTApp
{
    public partial class frmPAHalfOut : Form
    {
        bool isloaded = false;
        ...
        public frmPAHalfOut()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderByDismantle("", out ds, "11");
                //if (ds.Tables == null || ds.Tables["head"].Rows.Count == 0)
                //{
                //    MessageBox.Show("暂无未审核组装单！");
                //    return;
                //}
        ...
        private void frmPAHalfOut_Load(object sender, EventArgs e)
        {
        ...
        private bool verifyArrive(string OrderCode)
        {
            try
            {
                DataSet ds;
                if (rbtOther.Checked)
                    tempSIO = StockInBusiness.CreateSIOrderByDismantle("11", "", OrderCode, out ds);
        ...
        private bool ScanLabel()
        {
            ...
            try
            {
                ...
                {   //二维码
                    ...
                    {
                        lblProDate.Text = DateTime.Now.ToShortDateString();
                        lblValityDate.Text = DateTime.Now.ToShortDateString();
                    }
                }
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderByDismantle("11", "", cCode, out ds);
            if (sk == null)
                return true;
