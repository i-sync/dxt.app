...
namespace HTApp
{
    public partial class frmDIHalfIn : Form
    {
        bool isloaded = false;
        ...
        public frmDIHalfIn()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderByDismantle("", out ds, "00");
        ...
        private void frmDIHalfIn_Load(object sender, EventArgs e)
        {
        ...
        private bool verifyArrive(string OrderCode)
        {
            try
            {
                DataSet ds;
                if (rbtOther.Checked)
                    tempSIO = StockInBusiness.CreateSIOrderByDismantle("00", "", OrderCode, out ds);
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderByDismantle("00", "", cCode, out ds);
            if (sk == null)
                return true;
