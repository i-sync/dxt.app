...
namespace HTApp
{
    public partial class frmPAFinalIn : Form
    {
        bool isloaded = false;
        ...
        public frmPAFinalIn()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderByDismantle("", out ds, "10");
        ...
        private void frmPAFinalIn_Load(object sender, EventArgs e)
        {
        ...
        private bool verifyArrive(string OrderCode)
        {
            try
            {
                DataSet ds;
                if (rbtOther.Checked)
                    tempSIO = StockInBusiness.CreateSIOrderByDismantle("10", "", OrderCode, out ds);
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderByDismantle("10", "", cCode, out ds);
            if (sk == null)
                return true;
