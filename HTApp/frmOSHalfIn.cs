...
namespace HTApp
{
    public partial class frmOSHalfIn : Form
    {
        bool isloaded = false;
        ...
        public frmOSHalfIn()
        {
            ...
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderOSArrive("", "", "", 0, out ds);
                //if (ds.Tables == null || ds.Tables["head"].Rows.Count == 0)
                //{
                //    MessageBox.Show("委外到货单未审核，无法进行委外生产入库操作!");
                //    return;
                //}
        ...
        private void frmOSHalfIn_Load(object sender, EventArgs e)
        {
            Clear();
            Init();
        }
        ...
        private bool verifyArrive(string ArriveCode)
        {
            ...
            {
                DataSet ds;
                tempSIO = StockInBusiness.CreateSIOrderOSArrive(ArriveCode, "", "", 0, out ds);
                if (tempSIO.U8Details == null || tempSIO.U8Details.Count < 1)
                    return false;
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderOSArrive(cCode, "", "", 0, out ds);
