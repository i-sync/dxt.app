...
namespace HTApp
{
    public partial class frmDIFinalOut : Form
    {
        bool isloaded = false;
        ...
        public frmDIFinalOut()
        {
            InitializeComponent();
            try
            {
                //DataSet ds;
                //StockInBusiness.CreateSIOrderByDismantle("", out ds, "01");
                //if (ds.Tables == null || ds.Tables["head"].Rows.Count == 0)
                //{
                //    MessageBox.Show("暂无未审核拆卸单！");
                //    return;
                //}
        ...
        private void frmDIFinalOut_Load(object sender, EventArgs e)
        {
        ...
        private bool verifyArrive(string OrderCode)
        {
            try
            {
                DataSet ds;
                if (rbtOther.Checked)
                    tempSIO = StockInBusiness.CreateSIOrderByDismantle("01", "", OrderCode, out ds);
        ...
        private bool ErrSubmit()
        {
            ...
            DataSet ds;
            StockIn sk;
            sk = StockInBusiness.CreateSIOrderByDismantle("01", "", cCode, out ds);
            if (sk == null)
                return true;
